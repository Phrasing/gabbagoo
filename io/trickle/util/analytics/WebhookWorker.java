...
extends AbstractVerticle {
    ...
    public void handle(Map.Entry entry) {
        String string = (Integer)entry.getKey() != 3 ? ((Integer)entry.getKey() == 1 ? "https://discord.com/api/webhooks/822112940714098719/9IO77xtVfjoad2wWTPpz3rU1AdWqVOP1WdZ_ruRC6ysRI1OeMemxXAOgEVEeXb6NCeVb" : "https://discord.com/api/webhooks/822113112126914581/auCyRr4ObwUWqx2XCynGd_B_Yr6ZKmVZ_eIYI83Y_YpBZCua5Al_b9pkC3LGVrjR_Pfj") : "https://webhooks.aycd.io/webhooks/api/v1/send/10414/b8c8e7d7-321c-4a80-acec-2c9c85acec8a";
        CompositeFuture compositeFuture = CompositeFuture.all((Future)this.sendWebhook(string, entry), (Future)this.handleUserWebhook(entry));
    ...
    public Future sendWebhook(String string, Map.Entry entry) {
        ...
        this.client.postAbs(string).sendJson(entry.getValue()).onComplete(arg_0 -> this.lambda$sendWebhook$6(string, entry, promise, arg_0));
