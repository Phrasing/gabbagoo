...
public class WebhookUtils {
    ...
    public static JsonObject baseEmbed() {
        return new JsonObject().put("timestamp", (Object)Instant.now().toString()).put("footer", (Object)new JsonObject().put("text", (Object)String.format("Trickle v%d.%d.%d", 1, 0, 278)).put("icon_url", (Object)WebhookUtils.getIcon()));
    }
