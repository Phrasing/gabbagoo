...
public class SessionPreload {
    ...
    public CompletableFuture createCart(String string) {
        ...
        while (n++ < 99999) {
            ...
            try {
                ...
                CompletableFuture completableFuture5 = VertxUtil.randomSleep((long)5000L);
    ...
    public CompletableFuture fetch() {
        ...
        CompletableFuture completableFuture3 = Request.execute((HttpRequest)this.client.shopView(string));
        if (!completableFuture3.isDone()) {
            CompletableFuture completableFuture4 = completableFuture3;
...
lbl10:
                ...
                v1 = Request.execute((HttpRequest)var0.client.shopView((String)var2_2 /* !! */ ));
                if (!v1.isDone()) {
                    var14_20 = v1;
