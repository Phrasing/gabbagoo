...
extends TaskActor {
    ...
    public boolean shouldRunOnSchedule() {
        ...
        if (this.clock.isStopped()) return false;
        return true;
    }
        ...
        switch (var2_3) {
            case 0: {
                if (var0.scheduledMode) {
                    ...
                    v0 = VertxUtil.hardCodedSleep(var0.clock.getTimeTillRun());
                    if (!v0.isDone()) {
                        var3_6 = v0;
...
lbl46:
    ...
    public CompletableFuture runNormal() {
        ...
        CompletableFuture completableFuture5 = SessionPreload.createSession(this);
        if (!completableFuture5.isDone()) {
            CompletableFuture completableFuture6 = completableFuture5;
        ...
        try {
            ...
            if (this.griefMode) {
                ...
                CompletableFuture completableFuture16 = VertxUtil.handleEagerFuture(completableFuture15);
...
lbl25:
                    ...
                    while (true) {
                        ...
                        v3 = SessionPreload.createSession(var0);
                        if (!v3.isDone()) {
                            var6_13 = v3;
...
lbl39:
                            ...
                            while (true) {
                                ...
                                block19: while (true) {
                                    if (var2_2.toString().contains("\"isAvailable\":true")) ** GOTO lbl48
                                    v5 = VertxUtil.sleep(var0.task.getMonitorDelay());
                                    if (!v5.isDone()) {
                                        var6_15 = v5;
