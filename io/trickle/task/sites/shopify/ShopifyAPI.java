...
extends TaskApiClient {
    ...
    public HttpRequest checkpointPage() {
        HttpRequest httpRequest = this.client.getAbs("https://" + this.SITE_URL + "/checkpoint?return_to=https%3A%2F%2F" + this.SITE_URL + "%2Fcheckout").as(BodyCodec.buffer());
        httpRequest.putHeader("cache-control", "max-age=0");
        httpRequest.putHeader("upgrade-insecure-requests", "1");
    ...
    public String calculateAccessToken() {
        if (this.SITE_URL.equals("mntd-staging.myshopify.com")) {
            return "97aecd9d74bdf081bc0320959d805231";
        }
        if (this.SITE_URL.equals("getmntd-ca.myshopify.com")) {
            return "34d6cd77755dc21434a9d808511aad92";
        }
        if (this.SITE_URL.equals("getmntd-eu.myshopify.com")) {
            return "a822ea3bbe64015438d40b50dbaa685b";
        }
        if (!this.SITE_URL.equals("getmntd-uk.myshopify.com")) return "ef2a2e78515db639ca895bac3616ec0b";
    ...
    public HttpRequest shippingRateOld(String string, String string2, String string3) {
        HttpRequest httpRequest = this.client.getAbs("https://" + this.SITE_URL + "/cart/shipping_rates.json?shipping_address[zip]=" + string.replace(" ", "%20") + "&shipping_address[country]=" + string2.replace(" ", "%20") + "&shipping_address[province]=" + string3).as(BodyCodec.buffer());
        httpRequest.putHeader("sec-ch-ua", this.SEC_UA);
        httpRequest.putHeader("sec-ch-ua-mobile", "?0");
        httpRequest.putHeader("sec-ch-ua-platform", "\"Windows\"");
        httpRequest.putHeader("upgrade-insecure-requests", "1");
