...
extends TaskActor {
    ...
    public CompletableFuture shippingForm(String string) {
        ...
        multiMap2.add("checkout[shipping_rate][id]", (String)completableFuture.join().get());
...
lbl32:
                ...
                v0.put(v1, (Object)v2.put(v3, ((ShippingRateSupplier)v4.join()).get()));
...
lbl10:
    ...
    public CompletableFuture processingAPIForm() {
        ...
        jsonObject4.put("checkout", (Object)jsonObject5.put("shipping_rate", (Object)jsonObject6.put("id", completableFuture3.join().get())));
        return CompletableFuture.completedFuture(jsonObject);
    }
        ...
        while (this.running) {
            ...
            try {
                ...
                if (httpResponse.statusCode() == 200) {
                    ...
                    if (jsonArray.getJsonObject(jsonArray.size() - 1).getValue("transaction") != null && jsonArray.getJsonObject(jsonArray.size() + 1 + 1).getJsonObject("transaction").getValue("message") != null) {
                        return CompletableFuture.completedFuture(httpResponse.bodyAsJsonObject());
                    }
                }
...
lbl23:
    ...
    public CompletableFuture walletsCart(boolean bl, boolean bl2) {
        ...
        jsonObject2.put("shipping_line", (Object)jsonObject3.put("handle", completableFuture.join().get()));
...
lbl49:
                ...
                v3.put(v4, (Object)v5.put(v6, (Object)v7.put(v8, ((ShippingRateSupplier)v9 /* !! */ .join()).get())));
...
lbl25:
                ...
                v0.add(v1, (String)((ShippingRateSupplier)v2.join()).get());
