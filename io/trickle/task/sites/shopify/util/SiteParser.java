...
import io.trickle.task.sites.shopify.util.SiteParser$1;
...
public class SiteParser {
    ...
    public static Pair getProperties(Site site) {
        switch (site) {
            case KAWSONE: {
                return new Pair("_hkey", "789gfd78934hfk74jml849320");
            }
            case KITH: {
                return new Pair("upsell", "mens");
            }
            case STUSSY: {
                return new Pair("_stussy_lip", "_qdXpxlhm8D");
            }
        }
        return null;
    }
