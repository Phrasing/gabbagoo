...
lbl55:
    ...
    public CompletableFuture postSensors() {
        for (int i = 0; i < 2; ++i) {
            ...
            if (!completableFuture.isDone()) {
                ...
                return ((CompletableFuture)completableFuture2.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$postSensors(this, i, completableFuture2, null, 0, 1, arg_0));
            }
            ...
            if (!completableFuture3.isDone()) {
                ...
                return ((CompletableFuture)completableFuture4.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$postSensors(this, i, completableFuture4, null, 0, 2, arg_0));
            }
        ...
        while (n++ < n2) {
            ...
            if (!completableFuture.isDone()) {
                ...
                return ((CompletableFuture)completableFuture5.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$postSensors(this, n, completableFuture5, string, n2, 3, arg_0));
            }
            completableFuture.join();
            CompletableFuture completableFuture6 = this.sendSensor(this.api.postSensor(true), true);
            if (!completableFuture6.isDone()) {
                CompletableFuture completableFuture7 = completableFuture6;
                return ((CompletableFuture)completableFuture7.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$postSensors(this, n, completableFuture7, string, n2, 4, arg_0));
            }
            string = (String)completableFuture6.join();
            if (n > 6 && string != null && string.contains("false")) {
        ...
        if (string != null) {
            this.logger.info("Posted sensor: c={} l={} val={}", (Object)n, (Object)this.api.getCookies().getCookieValue("_abck").length(), (Object)string.replace("\n", " "));
    ...
    public CompletableFuture smartSleep(long l) {
        if (Engine.get().getClientConfiguration().getBoolean("firewall", Boolean.valueOf(true)) == false) return CompletableFuture.completedFuture(null);
...
lbl37:
     ...
     * Unable to fully structure code
     */
    public static CompletableFuture async$prepareCart(Yeezy var0, CompletableFuture var1_1, String var2_2, String var3_3, int var4_5, Object var5_7) {
        switch (var4_5) {
            case 0: {
                v0 = var0.getProductPage(true);
                if (!v0.isDone()) {
                    var5_7 = v0;
                    return var5_7.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$prepareCart(io.trickle.task.sites.yeezy.Yeezy java.util.concurrent.CompletableFuture java.lang.String java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (CompletableFuture)var5_7, null, null, (int)1));
                }
                ** GOTO lbl10
            }
            case 1: {
...
lbl10:
                ...
                if (!v1.isDone()) {
                    var5_7 = v1;
                    return var5_7.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$prepareCart(io.trickle.task.sites.yeezy.Yeezy java.util.concurrent.CompletableFuture java.lang.String java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (CompletableFuture)var5_7, (String)var1_1, null, (int)2));
                }
                ** GOTO lbl23
            }
            case 2: {
...
lbl23:
                ...
                if (!v2.isDone()) {
                    var5_7 = v2;
                    return var5_7.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$prepareCart(io.trickle.task.sites.yeezy.Yeezy java.util.concurrent.CompletableFuture java.lang.String java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (CompletableFuture)var5_7, (String)var1_1, null, (int)3));
                }
                ** GOTO lbl33
            }
            case 3: {
...
lbl33:
                ...
                if (!v3.isDone()) {
                    var5_7 = v3;
                    return var5_7.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$prepareCart(io.trickle.task.sites.yeezy.Yeezy java.util.concurrent.CompletableFuture java.lang.String java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (CompletableFuture)var5_7, (String)var1_1, null, (int)4));
                }
                ** GOTO lbl45
            }
            case 4: {
...
lbl47:
                ...
                if (!(v4 = var0.getSizeJson(var0.availableSizes.isEmpty() == false)).isDone()) {
                    var5_7 = v4;
                    return var5_7.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$prepareCart(io.trickle.task.sites.yeezy.Yeezy java.util.concurrent.CompletableFuture java.lang.String java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (CompletableFuture)var5_7, (String)var1_1, null, (int)5));
                }
                ** GOTO lbl54
            }
            case 5: {
...
lbl54:
                ...
                try {
                    var3_3 = new JsonObject(var2_2).getJsonArray("variation_list");
                    var4_6 = var3_3.stream().sorted((Comparator)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;Ljava/lang/Object;)I, lambda$prepareCart$5(java.lang.Object java.lang.Object ), (Ljava/lang/Object;Ljava/lang/Object;)I)()).map((Function<Object, JsonObject>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, lambda$prepareCart$6(java.lang.Object ), (Ljava/lang/Object;)Lio/vertx/core/json/JsonObject;)()).collect(Collectors.<T>toList());
                    if (!var4_6.isEmpty()) {
                        var0.availableSizes.clear();
                        var0.availableSizes.addAll(var4_6);
                    }
                }
                catch (Throwable var3_4) {
                    var0.logger.error("Could not order sizes (Normal. Don't panic): {}", (Object)var3_4.getMessage());
                }
                if (!(v5 = var0.postSensors()).isDone()) {
                    var5_7 = v5;
                    return var5_7.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$prepareCart(io.trickle.task.sites.yeezy.Yeezy java.util.concurrent.CompletableFuture java.lang.String java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (CompletableFuture)var5_7, (String)var1_1, (String)var2_2, (int)6));
                }
                ** GOTO lbl74
            }
            case 6: {
...
lbl74:
                ...
                v7 = Request.executeTillOk(var0.api.emptyBasket(true, var0.authorization));
                if (!v7.isDone()) {
                    var5_7 = v7;
                    return var5_7.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$prepareCart(io.trickle.task.sites.yeezy.Yeezy java.util.concurrent.CompletableFuture java.lang.String java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (CompletableFuture)var5_7, (String)var1_1, (String)var2_2, (int)7));
                }
                ** GOTO lbl88
            }
            case 7: {
...
lbl88:
    ...
    public CompletableFuture prepareCart() {
        ...
        if (!completableFuture.isDone()) {
            CompletableFuture completableFuture2 = completableFuture;
            return ((CompletableFuture)completableFuture2.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$prepareCart(this, completableFuture2, null, null, 1, arg_0));
        }
        ...
        if (!completableFuture3.isDone()) {
            CompletableFuture completableFuture4 = completableFuture3;
            return ((CompletableFuture)completableFuture4.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$prepareCart(this, completableFuture4, string, null, 2, arg_0));
        }
        completableFuture3.join();
        CompletableFuture completableFuture5 = this.sendBasic(this.api.secondaryProdAPI(), "Prod Info #1");
        if (!completableFuture5.isDone()) {
            CompletableFuture completableFuture6 = completableFuture5;
            return ((CompletableFuture)completableFuture6.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$prepareCart(this, completableFuture6, string, null, 3, arg_0));
        }
        completableFuture5.join();
        if (this.isFirstIteration) {
            ...
            if (!completableFuture7.isDone()) {
                ...
                return ((CompletableFuture)completableFuture8.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$prepareCart(this, completableFuture8, string, null, 4, arg_0));
            }
            completableFuture7.join();
        }
        CompletableFuture completableFuture9 = this.getSizeJson(!this.availableSizes.isEmpty());
        if (!completableFuture9.isDone()) {
            CompletableFuture completableFuture10 = completableFuture9;
            return ((CompletableFuture)completableFuture10.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$prepareCart(this, completableFuture10, string, null, 5, arg_0));
        }
        String string2 = (String)completableFuture9.join();
        try {
            JsonArray jsonArray = new JsonObject(string2).getJsonArray("variation_list");
            List list = jsonArray.stream().sorted(Yeezy::lambda$prepareCart$5).map(Yeezy::lambda$prepareCart$6).collect(Collectors.toList());
            if (!list.isEmpty()) {
        ...
        if (!completableFuture11.isDone()) {
            ...
            return ((CompletableFuture)completableFuture12.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$prepareCart(this, completableFuture12, string, string2, 6, arg_0));
        }
        ...
        if (!completableFuture13.isDone()) {
            ...
            return ((CompletableFuture)completableFuture14.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$prepareCart(this, completableFuture14, string, string2, 7, arg_0));
        }
...
lbl214:
     ...
     * Unable to fully structure code
     */
    public static CompletableFuture async$postSensors(Yeezy var0, int var1_1, CompletableFuture var2_3, String var3_5, int var4_7, int var5_12, Object var6_13) {
        switch (var5_12) {
            case 0: {
                var1_1 = 0;
lbl4:
                ...
                while (true) {
                    if (var1_1 >= 2) ** GOTO lbl11
                    v0 = var0.sendSensor(var0.api.postSensor(true), false);
                    if (!v0.isDone()) {
                        var4_8 = v0;
                        return var4_8.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$postSensors(io.trickle.task.sites.yeezy.Yeezy int java.util.concurrent.CompletableFuture java.lang.String int int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (int)var1_1, (CompletableFuture)var4_8, null, (int)0, (int)1));
                    }
                    ** GOTO lbl23
lbl11:
                    // 1 sources
                    ...
                    var1_2 = "";
                    var2_4 = 0;
                    var3_6 = ThreadLocalRandom.current().nextInt(9, 13);
lbl14:
                    // 2 sources
                    ...
                    while (var2_4++ < var3_6) {
                        ...
                        if (!v1.isDone()) {
                            var4_10 = v1;
                            return var4_10.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$postSensors(io.trickle.task.sites.yeezy.Yeezy int java.util.concurrent.CompletableFuture java.lang.String int int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (int)var2_4, (CompletableFuture)var4_10, (String)var1_2, (int)var3_6, (int)3));
                        }
                        ** GOTO lbl41
                    }
                    ** GOTO lbl64
...
lbl23:
                ...
                if (!v2.isDone()) {
                    var4_9 = v2;
                    return var4_9.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$postSensors(io.trickle.task.sites.yeezy.Yeezy int java.util.concurrent.CompletableFuture java.lang.String int int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (int)var1_1, (CompletableFuture)var4_9, null, (int)0, (int)2));
                }
                ** GOTO lbl32
            }
            case 2: {
...
lbl41:
                ...
                v1.join();
                v3 = var0.sendSensor(var0.api.postSensor(true), true);
                if (!v3.isDone()) {
                    var4_11 = v3;
                    return var4_11.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$postSensors(io.trickle.task.sites.yeezy.Yeezy int java.util.concurrent.CompletableFuture java.lang.String int int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (int)var2_4, (CompletableFuture)var4_11, (String)var1_2, (int)var3_6, (int)4));
                }
                ** GOTO lbl53
            }
            case 4: {
...
lbl53:
                ...
                var1_2 = (String)v3.join();
                if (var2_4 <= 6 || var1_2 == null || !var1_2.contains("false")) ** GOTO lbl57
                var0.logger.info("YS site down!");
                ** GOTO lbl64
lbl57:
                // 1 sources

                if (var0.api.getCookies().getCookieValue("_abck").length() < 561 || var0.api.getCookies().getCookieValue("_abck").contains("||")) ** GOTO lbl61
                var0.logger.info("Passed sensor validation step -> Handling sensor step='{}/{}' - len={}", (Object)var2_4, (Object)var3_6, (Object)var0.api.getCookies().getCookieValue("_abck").length());
                if (var2_4 <= 4 || !var0.isBannedOnShipping) ** GOTO lbl62
                ** GOTO lbl64
lbl61:
                // 1 sources

                var0.logger.info("Handling sensor step='{}/{}' len={}", (Object)var2_4, (Object)var3_6, (Object)var0.api.getCookies().getCookieValue("_abck").length());
lbl62:
                // 2 sources
...
lbl64:
                ...
                if (var1_2 != null) {
                    var0.logger.info("Posted sensor: c={} l={} val={}", (Object)var2_4, (Object)var0.api.getCookies().getCookieValue("_abck").length(), (Object)var1_2.replace("\n", " "));
                    return CompletableFuture.completedFuture(null);
                }
...
lbl61:
    ...
    public CompletableFuture processPayment(HttpRequest httpRequest, String string) {
        ...
        while (n < 250) {
            ...
            try {
                ...
                this.api.getCookies().put("utag_main", this.api.fetchUtag(), ".yeezysupply.com");
                String string2 = Adyen12.getCSEToken(this.task.getProfile());
                ...
                String string3 = "{\"basketId\":\"" + string + "\",\"encryptedInstrument\":\"" + string2 + "\",\"paymentInstrument\":{\"holder\":\"" + this.task.getProfile().getFirstName().substring(0, 1).toUpperCase() + this.task.getProfile().getFirstName().substring(1).toLowerCase() + " " + this.task.getProfile().getLastName().substring(0, 1).toUpperCase() + this.task.getProfile().getLastName().substring(1).toLowerCase() + "\",\"expirationMonth\":" + (this.task.getProfile().getExpiryMonth().charAt(0) == '0' ? this.task.getProfile().getExpiryMonth().substring(1) : this.task.getProfile().getExpiryMonth()) + ",\"expirationYear\":" + this.task.getProfile().getExpiryYear() + ",\"lastFour\":\"" + this.task.getProfile().getCardNumber().substring(12) + "\",\"paymentMethodId\":\"CREDIT_CARD\",\"cardType\":\"" + this.task.getProfile().getPaymentMethod().get().replace("MASTERCARD", "MASTER") + "\"},\"fingerprint\":\"ryEGX8eZpJ0030000000000000bsx09CX6tD0119707416cVB94iKzBGa0zW3qWYPi5S16Goh5Mk004NMWer10CgS00000YVxEr00000F2e2nkLQB0DGiMVSwn2S:40\"}";
                        ...
                        if (httpResponse.statusCode() != 201) {
                            ...
                            if (string4.contains("HTTP 403 - Forbidden")) {
                                ...
                                if (string4.contains("basket_not_found_exception") || string4.contains("{\"invalidFields\":[\"Product items\"]")) {
                                    ...
                                    if (this.task.getMode().contains("noqueue")) {
                                        CompletableFuture completableFuture4 = VertxUtil.sleep(999999L);
                                        if (!completableFuture4.isDone()) {
                                            CompletableFuture completableFuture5 = completableFuture4;
                                    ...
                                    CompletableFuture completableFuture6 = this.prepareCart();
                                    if (!completableFuture6.isDone()) {
                                        CompletableFuture completableFuture7 = completableFuture6;
                                    ...
                                    completableFuture6.join();
                                    CompletableFuture completableFuture8 = this.cart();
                                    if (!completableFuture8.isDone()) {
                                        CompletableFuture completableFuture9 = completableFuture8;
                                    ...
                                    CompletableFuture completableFuture10 = this.checkout();
                                    if (!completableFuture10.isDone()) {
                                        CompletableFuture completableFuture11 = completableFuture10;
                                        return ((CompletableFuture)completableFuture11.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$processPayment(this, httpRequest, string, n, string2, completableFuture11, string3, httpResponse, string4, null, null, null, 6, arg_0));
                                    }
                                    completableFuture10.join();
                                    return CompletableFuture.completedFuture(null);
                                }
                            ...
                            if (string4.getString("paymentStatus").equalsIgnoreCase("not_paid") && string4.getString("authorizationType").contains("3ds")) {
                                ...
                                CompletableFuture completableFuture12 = this.get3DS2Page((JsonObject)string4);
                                if (!completableFuture12.isDone()) {
                                    CompletableFuture completableFuture13 = completableFuture12;
                                    return ((CompletableFuture)completableFuture13.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$processPayment(this, httpRequest, string, n, string2, completableFuture13, string3, httpResponse, null, (JsonObject)string4, null, null, 7, arg_0));
                                }
                                object = (Window3DS2)completableFuture12.join();
                                if (object != null) {
                                    Analytics.warning("Starting 3DS Processing!", this.task);
                                    this.logger.info("Awaiting confirmation...");
                                    CompletableFuture completableFuture14 = ((Window3DS2)object).invoke();
                                    ...
                                    CompletableFuture completableFuture16 = this.handleAfter3DS((Window3DS2)object);
                                    if (!completableFuture16.isDone()) {
                                        CompletableFuture completableFuture17 = completableFuture16;
                                        return ((CompletableFuture)completableFuture17.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$processPayment(this, httpRequest, string, n, string2, completableFuture17, string3, httpResponse, null, (JsonObject)string4, (Window3DS2)object, null, 9, arg_0));
                                    }
                                    boolean bl = (Boolean)completableFuture16.join();
                                    if (bl) {
                ...
                CompletableFuture completableFuture18 = VertxUtil.randomSleep(this.task.getRetryDelay());
                ...
                if (httpResponse != null && httpResponse.statusCode() == 403) {
                    CompletableFuture completableFuture20 = this.prepareCart();
                ...
                CompletableFuture completableFuture22 = this.postSensors();
                if (!completableFuture22.isDone()) {
                    CompletableFuture completableFuture23 = completableFuture22;
                    return ((CompletableFuture)completableFuture23.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$processPayment(this, httpRequest, string, n, string2, completableFuture23, string3, httpResponse, null, null, null, null, 12, arg_0));
                }
                ...
                CompletableFuture completableFuture = VertxUtil.randomSleep(3000L);
                if (!completableFuture.isDone()) {
                    CompletableFuture completableFuture24 = completableFuture;
                    return ((CompletableFuture)completableFuture24.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$processPayment(this, httpRequest, string, n, null, completableFuture24, null, null, null, null, null, exception, 13, arg_0));
                }
                completableFuture.join();
            }
        }
    ...
    public static CompletableFuture async$processPayment(Yeezy var0, HttpRequest var1_1, String var2_2, int var3_3, String var4_4, CompletableFuture var5_6, String var6_7, HttpResponse var7_8, String var8_9, JsonObject var9_10, Window3DS2 var10_12, Exception var11_13, int var12_14, Object var13_15) {
         ...
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [17[CATCHBLOCK]], but top level block is 30[UNCONDITIONALDOLOOP]
         *     at org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.processEndingBlocks(Op04StructuredStatement.java:435)
         *     at org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.buildNestedBlocks(Op04StructuredStatement.java:484)
         *     at org.benf.cfr.reader.bytecode.analysis.opgraph.Op03SimpleStatement.createInitialStructuredBlock(Op03SimpleStatement.java:736)
         *     at org.benf.cfr.reader.bytecode.CodeAnalyser.getAnalysisInner(CodeAnalyser.java:845)
    ...
    public static JsonObject lambda$prepareCart$6(Object object) {
...
lbl32:
    ...
    public CompletableFuture cart() {
            ...
            if (this.task.getSize().equalsIgnoreCase("random") && !this.availableSizes.isEmpty()) {
                ...
                try {
                    ...
                    if (this.availableSizes.isEmpty()) {
                        ...
                        string = list.get(ThreadLocalRandom.current().nextInt(list.size()));
        ...
        while (this.running) {
            ...
            try {
                string = this.api.addToCart();
                CompletableFuture completableFuture = Request.send((HttpRequest)string, buffer);
                if (!completableFuture.isDone()) {
                    CompletableFuture completableFuture2 = completableFuture;
                    return ((CompletableFuture)completableFuture2.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$cart(this, buffer, n, (HttpRequest)string, completableFuture2, null, null, 1, arg_0));
                }
                HttpResponse httpResponse = (HttpResponse)completableFuture.join();
                if (httpResponse != null) {
                    Object object;
                    ...
                    if (httpResponse.statusCode() == 403) {
                        ...
                        if (((String)object).contains("branding_url_content")) {
                            CompletableFuture completableFuture3 = this.handlePOW((String)object);
                            if (!completableFuture3.isDone()) {
                                CompletableFuture completableFuture4 = completableFuture3;
                                return ((CompletableFuture)completableFuture4.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$cart(this, buffer, n, (HttpRequest)string, completableFuture4, httpResponse, (String)object, 2, arg_0));
                            }
                            completableFuture3.join();
                            continue;
                        }
            ...
            if (!completableFuture.isDone()) {
                CompletableFuture completableFuture5 = completableFuture;
                return ((CompletableFuture)completableFuture5.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$cart(this, buffer, n, null, completableFuture5, null, null, 3, arg_0));
            }
            completableFuture.join();
            CompletableFuture completableFuture6 = this.prepareCart();
            if (!completableFuture6.isDone()) {
                CompletableFuture completableFuture7 = completableFuture6;
                return ((CompletableFuture)completableFuture7.exceptionally(Function.identity())).thenCompose(arg_0 -> Yeezy.async$cart(this, buffer, n, null, completableFuture7, null, null, 4, arg_0));
            }
            completableFuture6.join();
        }
        return CompletableFuture.completedFuture(null);
    ...
    public CompletableFuture submitShippingAndBilling(HttpRequest httpRequest) {
        String string = "{\"customer\":{\"email\":\"" + this.task.getProfile().getEmail() + "\",\"receiveSmsUpdates\":false},\"shippingAddress\":{\"country\":\"US\",\"firstName\":\"" + this.task.getProfile().getFirstName().substring(0, 1).toUpperCase() + this.task.getProfile().getFirstName().substring(1).toLowerCase() + "\",\"lastName\":\"" + this.task.getProfile().getLastName().substring(0, 1).toUpperCase() + this.task.getProfile().getLastName().substring(1).toLowerCase() + "\",\"address1\":\"" + this.task.getProfile().getAddress1() + "\",\"address2\":\"" + this.task.getProfile().getAddress2() + "\",\"city\":\"" + this.task.getProfile().getCity().substring(0, 1).toUpperCase() + this.task.getProfile().getCity().substring(1).toLowerCase() + "\",\"stateCode\":\"" + this.task.getProfile().getState() + "\",\"zipcode\":\"" + this.task.getProfile().getZip() + "\",\"phoneNumber\":\"" + this.task.getProfile().getPhone() + "\"},\"billingAddress\":{\"country\":\"US\",\"firstName\":\"" + this.task.getProfile().getFirstName().substring(0, 1).toUpperCase() + this.task.getProfile().getFirstName().substring(1).toLowerCase() + "\",\"lastName\":\"" + this.task.getProfile().getLastName().substring(0, 1).toUpperCase() + this.task.getProfile().getLastName().substring(1).toLowerCase() + "\",\"address1\":\"" + this.task.getProfile().getAddress1() + "\",\"address2\":\"" + this.task.getProfile().getAddress2() + "\",\"city\":\"" + this.task.getProfile().getCity().substring(0, 1).toUpperCase() + this.task.getProfile().getCity().substring(1).toLowerCase() + "\",\"stateCode\":\"" + this.task.getProfile().getState() + "\",\"zipcode\":\"" + this.task.getProfile().getZip() + "\",\"phoneNumber\":\"" + this.task.getProfile().getPhone() + "\"},\"methodList\":[{\"id\":\"2ndDay-1\",\"shipmentId\":\"me\",\"collectionPeriod\":\"\",\"deliveryPeriod\":\"\"}],\"newsletterSubscription\":true}";
        while (true) {
            this.checkHmac();
            try {
                ...
                if (httpResponse != null && httpResponse.statusCode() != 200) {
                    ...
                    if (((String)httpResponse.body()).contains("The shipping address postal code is blacklisted")) {
                        this.logger.info("Banned zipcode found -> zipcode={}", (Object)this.task.getProfile().getZip());
                    }
     ...
     * Could not resolve type clashes
     */
    public static CompletableFuture async$cart(Yeezy var0, Buffer var1_1, int var2_3, HttpRequest var3_8, CompletableFuture var4_10, HttpResponse var5_11, String var6_12, int var7_13, Object var8_18) {
        switch (var7_13) {
            case 0: {
                ...
                if (!var0.task.getSize().equalsIgnoreCase("random") || var0.availableSizes.isEmpty()) ** GOTO lbl18
                var0.logger.info("Picking any available size...");
                try {
                    var1_1 = var0.api.atcForm(Sizes.findAnyAvailableJSON(var0.availableSizes)).toBuffer();
                }
                catch (Sizes$NoAvailableSizeException var2_4) {
                    var0.logger.info("All sizes reported out of stock. Trying anyways...");
                    var1_1 = var0.api.atcForm(Sizes.findAnyJSON(var0.availableSizes)).toBuffer();
                }
                ** GOTO lbl44
lbl18:
                // 1 sources

                if (!var0.task.getSize().contains("&")) ** GOTO lbl33
                try {
                    var2_5 = Arrays.asList(var0.task.getSize().toLowerCase().split("&"));
                    if (!var0.availableSizes.isEmpty()) ** GOTO lbl26
                    var0.logger.info("No pre-fetched sizes available. Picking any within range...");
                    var3_8 /* !! */  = var2_5.get(ThreadLocalRandom.current().nextInt(var2_5.size()));
                    var1_1 = var0.api.atcForm((String)var3_8 /* !! */ ).toBuffer();
                    ** GOTO lbl44
lbl26:
                    // 1 sources

                    var0.logger.info("Picking any available size within range...");
                    var1_1 = var0.api.atcForm(Sizes.findAnyAvailableOfRangeJSON(var2_5, var0.availableSizes)).toBuffer();
                }
                catch (Throwable var2_6) {
                    var0.logger.warn("Failed to pick sizes within range. Recovering: {}", (Object)var2_6.getMessage());
                    var1_1 = var0.api.atcForm().toBuffer();
                }
                ** GOTO lbl44
lbl33:
                // 1 sources

                if (!var0.task.getSize().contains("random") && !var0.availableSizes.isEmpty()) {
                    var0.logger.info("Selecting specific size [dyn-list-iter]");
                    try {
                        var1_1 = var0.api.atcForm(Sizes.findAnyAvailableOfRangeJSON(List.of(var0.task.getSize()), var0.availableSizes)).toBuffer();
                    }
                    catch (Throwable var2_7) {
                        var0.logger.warn("Failed to pick size. Recovering: {}", (Object)var2_7.getMessage());
                        var1_1 = var0.api.atcForm().toBuffer();
                    }
                } else {
                    var0.logger.info("Using size choice of size={}", (Object)var0.task.getSize());
                    var1_1 = var0.api.atcForm().toBuffer();
                }
lbl44:
                // 8 sources
                ...
                block17: while (var0.running != false) {
                    var0.checkHmac();
                    var0.logger.info("Adding to cart");
                    try {
                        var3_8 /* !! */  = var0.api.addToCart();
                        v0 = Request.send(var3_8 /* !! */ , var1_1);
                        if (!v0.isDone()) {
                            var7_14 = v0;
                            return var7_14.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$cart(io.trickle.task.sites.yeezy.Yeezy io.vertx.core.buffer.Buffer int io.vertx.ext.web.client.HttpRequest java.util.concurrent.CompletableFuture io.vertx.ext.web.client.HttpResponse java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (Buffer)var1_1, (int)var2_3, (HttpRequest)var3_8 /* !! */ , (CompletableFuture)var7_14, null, null, (int)1));
                        }
lbl55:
                        // 3 sources

                        while (true) {
                            var4_10 = (HttpResponse)v0.join();
                            if (var4_10 != null) {
                                var0.logger.info("ATC Responded with status={}", (Object)var4_10.statusCode());
                                if (var4_10.statusCode() == 403) {
                                    var0.isPassedFW = false;
                                    var2_3 = 0;
                                    var0.logger.warn("FW Blocked on ATC");
                                    var0.netLogWarn("Failed to ATC: state='FW' status=" + var4_10.statusCode());
                                    ...
                                    var5_11 = ((String)var4_10.body()).replace("\n", "");
                                    var2_3 = 1;
                                    if (var5_11.contains("branding_url_content")) {
                                        v1 = var0.handlePOW((String)var5_11);
                                        if (!v1.isDone()) {
                                            var7_15 = v1;
                                            return var7_15.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$cart(io.trickle.task.sites.yeezy.Yeezy io.vertx.core.buffer.Buffer int io.vertx.ext.web.client.HttpRequest java.util.concurrent.CompletableFuture io.vertx.ext.web.client.HttpResponse java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (Buffer)var1_1, (int)var2_3, (HttpRequest)var3_8 /* !! */ , (CompletableFuture)var7_15, (HttpResponse)var4_10, (String)var5_11, (int)2));
                                        }
lbl74:
                                        // 3 sources
                                    ...
                                    if (var5_11.contains("basketId")) {
                                        var0.authorization = var4_10.getHeader("authorization");
                                        if (var0.authorization == null) {
                                            var0.logger.error("Fake cart (animal)");
                                            var0.netLogWarn("Fake cart (animal) body='" + (String)var5_11 + "'");
                                            ...
                                            if (!var5_11.contains("\"total\":0") || var0.task.getMode().contains("noqueue")) {
                                                var0.logger.info("ATC SUCCESSFUL count={} time={}: {}", (Object)Yeezy.successfulCartCount++, (Object)(System.currentTimeMillis() - var0.pixelPostTs), var5_11);
                                                var0.basketID = new JsonObject((String)var5_11).getString("basketId");
                                                var0.netLogInfo("ATC SUCCESSFUL body='" + (String)var5_11 + "'");
                                                ...
                                                var6_12 = var0.tokenRef.get();
                                                var6_12.markPassed();
                                                var0.tokenRef.set(null);
                                                return CompletableFuture.completedFuture(null);
                                            }
                                            var0.logger.info("EMPTY_CART (OOS): {}", var5_11);
                                            var0.netLogInfo("EMPTY_CART (OOS): body='" + (String)var5_11 + "'");
                                        }
                                    } else if (var5_11.length() == 0) {
                                        var0.logger.warn("Failed to ATC: state={} status={}", (Object)"Blocked by FW", (Object)var4_10.statusCode());
                                        var0.netLogWarn("Failed to ATC: state='FW Blocked' status=" + var4_10.statusCode());
                                    } else if (var5_11.contains("HTTP 403 - Forbidden")) {
                                        var2_3 = 0;
                                        var0.logger.warn("Failed to ATC: state={} status={}", (Object)"Blocked by 403 body", (Object)var4_10.statusCode());
                                        var0.netLogWarn("Failed to ATC: state='Blocked by 403 body' status=" + var4_10.statusCode());
                                    } else if (var4_10.statusCode() == 400) {
                                        var0.logger.warn("Failed to ATC: state={} status={}", (Object)"Blocked by 400 (bad session)", (Object)var4_10.statusCode());
                                        var0.netLogWarn("Failed to ATC: state='Blocked by 400 (bad session)' status=" + var4_10.statusCode());
                                    } else {
                                        var0.logger.warn("Failed to ATC: state={} status={} body={}", (Object)"No Basket", (Object)var4_10.statusCode(), var4_10.body());
                                        var0.netLogWarn("Failed to ATC: state='No Basket' status=" + var4_10.statusCode() + " body='" + (String)var5_11 + "'");
                                    }
                                }
                                if (var2_3 != 0 && var0.tokenRef.get() != null) {
                                    var5_11 = var0.tokenRef.get();
                                    var5_11.markPassed();
                                    var0.tokenRef.set(null);
                                }
                            } else {
                        ...
                        var0.logger.error("Error adding to cart: {}", (Object)var3_9.getMessage());
                        var0.netLogError("Error adding to cart: message=" + var3_9.getMessage());
                    }
                    if (!(v2 = var0.smartSleep(var0.task.getRetryDelay())).isDone()) {
                        var7_16 = v2;
                        return var7_16.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$cart(io.trickle.task.sites.yeezy.Yeezy io.vertx.core.buffer.Buffer int io.vertx.ext.web.client.HttpRequest java.util.concurrent.CompletableFuture io.vertx.ext.web.client.HttpResponse java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (Buffer)var1_1, (int)var2_3, null, (CompletableFuture)var7_16, null, null, (int)3));
                    }
lbl126:
                    // 3 sources
                    ...
                    while (true) {
                        ...
                        if (!v3.isDone()) {
                            var7_17 = v3;
                            return var7_17.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$cart(io.trickle.task.sites.yeezy.Yeezy io.vertx.core.buffer.Buffer int io.vertx.ext.web.client.HttpRequest java.util.concurrent.CompletableFuture io.vertx.ext.web.client.HttpResponse java.lang.String int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((Yeezy)var0, (Buffer)var1_1, (int)var2_3, null, (CompletableFuture)var7_17, null, null, (int)4));
                        }
lbl133:
                        // 3 sources
...
lbl11:
    ...
    public static int lambda$prepareCart$5(Object object, Object object2) {
    ...
    public CompletableFuture handleCode() {
        ...
        while (this.running) {
            try {
                if (string == null) {
                    CompletableFuture completableFuture = CodeScreen.request(this.id, this.task.getProfile().getPhone());
                    if (!completableFuture.isDone()) {
                        CompletableFuture completableFuture2 = completableFuture;
                    ...
                    if (httpResponse.statusCode() == 200) {
                        ...
                        if (httpResponse.getHeader("authorization") == null) {
                            ...
                            if (string2.contains("invalid_coupon_code_exception")) {
                                this.logger.warn("Invalid code: code={} for phone number: phone={}. Retrying...", (Object)string, (Object)this.task.getProfile().getPhone());
                                if (n++ >= 20) {
