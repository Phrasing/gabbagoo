 ...
 *  io.trickle.imap.MessageUtils
 *  io.trickle.task.Task
 *  io.trickle.task.sites.bestbuy.BestbuyAPI
 *  io.trickle.task.sites.bestbuy.Encryption
 *  io.trickle.task.sites.bestbuy.Login
...
lbl23:
                ...
                v1.join();
                v2 = VertxUtil.hardCodedSleep((long)500L);
                if (!v2.isDone()) {
                    var3_3 = v2;
...
lbl33:
                ...
                v2.join();
                v3 = Request.send((HttpRequest)var1_1);
                if (!v3.isDone()) {
                    var3_3 = v3;
...
lbl10:
                ...
                var2_3 = new JsonObject(Objects.requireNonNull(Utils.quickParseFirst((String)var1_1, (Pattern[])new Pattern[]{Bestbuy.orderDataPattern})));
        ...
        switch (var4_4) {
            case 0: {
                if (var0.imapClient == null) {
                    var0.imapClient = MailClient.create((Vertx)VertxSingleton.INSTANCE.get());
                }
...
lbl21:
                ...
                while (true) {
                    if (var2_2.length != 0) {
                        var3_3 /* !! */  = MessageUtils.getTextFromMessage((Message)var2_2[var2_2.length - 1]);
                        return CompletableFuture.completedFuture(Utils.quickParseFirst((String)var3_3 /* !! */ , (Pattern[])new Pattern[]{Bestbuy.VERIFICATION_CODE}));
                    }
                    var0.logger.error("Waiting for email to arrive... [{}]", (Object)var1_1.getUser());
                    v2 = VertxUtil.randomSleep((long)var0.task.getRetryDelay());
                    if (!v2.isDone()) {
                        var4_7 = v2;
    ...
    public CompletableFuture sendSensor() {
        ...
        while (true) {
            ...
            try {
                ...
                CompletableFuture completableFuture5 = Request.send((HttpRequest)httpRequest, (Buffer)buffer);
...
lbl14:
                ...
                if ((var3_3 = Utils.quickParseFirst((String)(var2_2 = (String)v0.join()), (Pattern[])new Pattern[]{Bestbuy.ORDER_FAIL_REASON})) == null) ** GOTO lbl5
...
lbl69:
                ...
                v7 = VertxUtil.randomSleep((long)var0.task.getMonitorDelay());
                if (!v7.isDone()) {
                    var4_4 = v7;
...
lbl131:
            ...
            try {
                ...
                if (httpResponse != null) {
                    ...
                    if (httpResponse.statusCode() == 200 && string.contains("\"cartCount\":1")) {
                        VertxUtil.sendSignal((String)this.task.getKeywords()[0]);
                        this.logger.info("Successfully atc! Cookie -> [{}]", (Object)Analytics.exportVT((CookieJar)this.api.getCookies()));
                        return CompletableFuture.completedFuture(null);
                    }
                    ...
                    if (string.contains("CONSTRAINED_ITEM")) {
                        ...
                        if (this.task.getKeywords().length == 2 && Utils.isInteger((String)this.task.getKeywords()[1])) {
                        ...
                        CompletableFuture completableFuture13 = VertxUtil.hardCodedSleep((long)(n + 3000));
                    ...
                    if (string.contains("Sorry, there was a problem adding the item to your cart.")) {
                        ...
                        for (Cookie cookie : this.api.getCookies().get(Boolean.valueOf(true), "bestbuy.com", "/")) {
                ...
                CompletableFuture completableFuture21 = VertxUtil.signalSleep((String)this.task.getKeywords()[0], (long)this.task.getMonitorDelay());
                ...
                CompletableFuture completableFuture23 = VertxUtil.randomSleep((long)this.task.getRetryDelay());
    ...
    public CompletableFuture placeOrder() {
        ...
        while (true) {
            ...
            String string2 = Utils.quickParseFirst((String)string, (Pattern[])new Pattern[]{ORDER_FAIL_REASON});
            ...
            CompletableFuture completableFuture21 = VertxUtil.randomSleep((long)this.task.getMonitorDelay());
            if (!completableFuture21.isDone()) {
                CompletableFuture completableFuture22 = completableFuture21;
...
lbl23:
                            ...
                            while (true) {
                                ...
                                var4_5 = new JsonObject().put("sensor_data", (Object)var3_3 /* !! */ ).toBuffer();
...
lbl31:
                            ...
                            v4 = VertxUtil.randomSleep((long)var0.task.getRetryDelay());
                            if (!v4.isDone()) {
                                var8_9 = v4;
...
lbl42:
    ...
    public CompletableFuture sendEnforcedReq(HttpRequest httpRequest) {
        ...
        while (true) {
            ...
            completableFuture3.join();
            CompletableFuture completableFuture5 = VertxUtil.hardCodedSleep((long)500L);
            if (!completableFuture5.isDone()) {
                CompletableFuture completableFuture6 = completableFuture5;
            ...
            completableFuture5.join();
            CompletableFuture completableFuture7 = Request.send((HttpRequest)httpRequest);
            if (!completableFuture7.isDone()) {
                CompletableFuture completableFuture8 = completableFuture7;
    ...
    public CompletableFuture sendEnforcedReq(HttpRequest httpRequest, Object object) {
        ...
        while (true) {
            ...
            completableFuture5.join();
            CompletableFuture completableFuture7 = Request.send((HttpRequest)httpRequest, (Object)object);
            if (!completableFuture7.isDone()) {
                CompletableFuture completableFuture8 = completableFuture7;
    ...
    public CompletableFuture encryptCard() {
        ...
        String string2 = Utils.quickParseFirst((String)string, (Pattern[])new Pattern[]{publicKeyPattern});
        String string3 = string.split("keyId\":\"")[1].split("\"")[0];
        this.api.encryptedCard = Encryption.getFullEncrypted((String)this.task.getProfile().getCardNumber(), (String)string2, (String)string3);
        return CompletableFuture.completedFuture(null);
    }
    ...
    public static CompletableFuture async$sendEnforcedReq$1(Bestbuy var0, HttpRequest var1_1, Object var2_2, CompletableFuture var3_3, HttpResponse var4_4, int var5_5, Object var6_6) {
        switch (var5_5) {
            case 0: {
                v0 = Request.send((HttpRequest)var1_1, (Object)var2_2);
                if (!v0.isDone()) {
                    var4_4 = v0;
...
lbl33:
                ...
                v2.join();
                v3 = Request.send((HttpRequest)var1_1, (Object)var2_2);
                if (!v3.isDone()) {
                    var4_4 = v3;
...
lbl10:
                ...
                var1_1 = (String)v0.join();
                var2_3 = Utils.quickParseFirst((String)var1_1, (Pattern[])new Pattern[]{Bestbuy.publicKeyPattern});
                var3_4 = var1_1.split("keyId\":\"")[1].split("\"")[0];
                var0.api.encryptedCard = Encryption.getFullEncrypted((String)var0.task.getProfile().getCardNumber(), (String)var2_3, (String)var3_4);
                return CompletableFuture.completedFuture(null);
            }
        }
        throw new IllegalArgumentException();
...
lbl279:
                ...
                Analytics.success((Task)var0.task, (JsonObject)new JsonObject(var5_7), (String)var0.api.proxyStringSafe());
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    Analytics.success((Task)this.task, (JsonObject)new JsonObject(string4), (String)this.api.proxyStringSafe());
...
lbl35:
    ...
    public CompletableFuture getLoginVerificationCode(Account account) {
        if (this.imapClient == null) {
            this.imapClient = MailClient.create((Vertx)VertxSingleton.INSTANCE.get());
        }
        ...
        while (true) {
            if (messageArray.length != 0) {
                String string = MessageUtils.getTextFromMessage((Message)messageArray[messageArray.length - 1]);
                return CompletableFuture.completedFuture(Utils.quickParseFirst((String)string, (Pattern[])new Pattern[]{VERIFICATION_CODE}));
            }
            ...
            try {
                ...
                if (httpResponse != null) {
                    ...
                    if ((n == null || httpResponse.statusCode() == n.intValue()) && bl) {
                        return CompletableFuture.completedFuture(httpResponse.statusCode() == 302 ? httpResponse.getHeader("location") : httpResponse.bodyAsString());
                    }
                    if (pair != null) {
...
lbl10:
                ...
                var3_3 = LoginController.initBrowserLogin((String)var1_1, (Iterable)var0.api.getCookies().get(Boolean.valueOf(true), ".bestbuy.com", "/"), (String)var0.api.proxyStringFull(), (CookieJar)var0.api.getCookies(), (String)var2_2);
...
lbl165:
    ...
    public CompletableFuture getLineId() {
        ...
        String string = (String)completableFuture.join();
        JsonObject jsonObject = new JsonObject(Objects.requireNonNull(Utils.quickParseFirst((String)string, (Pattern[])new Pattern[]{orderDataPattern})));
    ...
    public static String genCustomUuidV1(int n) {
        ...
        return String.join((CharSequence)"-", Utils.quickParseAllGroups((String)(string + string + string).substring(0, 32), (Pattern)UUID_PATTERN));
    }
    ...
    public CompletableFuture login(String string) {
        ...
        CompletableFuture completableFuture3 = LoginController.initBrowserLogin((String)string, (Iterable)this.api.getCookies().get(Boolean.valueOf(true), ".bestbuy.com", "/"), (String)this.api.proxyStringFull(), (CookieJar)this.api.getCookies(), (String)string2);
        this.api.login = Login.loginValues((String)string2);
