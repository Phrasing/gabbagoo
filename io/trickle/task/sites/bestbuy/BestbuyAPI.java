...
extends TaskApiClient {
    ...
    public JsonObject accountLoginForm(Account account, JsonObject jsonObject, JsonObject jsonObject2) {
        String string = Encryption.encryptGeneral((String)jsonObject.getString("publicKey"), (String)("{\"mouseMoved\":true,\"keyboardUsed\":false,\"fieldReceivedInput\":true,\"fieldReceivedFocus\":true,\"timestamp\":\"" + BASIC_ISO_DATE.format(Instant.now()) + "\",\"email\":\"" + account.getUser() + "\"}"));
        ...
        jsonObject3.put("encryptedEmail", (Object)("1:" + jsonObject2.getString("keyId") + ":" + Encryption.encryptGeneral((String)jsonObject2.getString("publicKey"), (String)account.getUser())));
        jsonObject3.put(this.login.getCode(), (Object)account.getPass());
        jsonObject3.put("info", (Object)("1:" + jsonObject.getString("keyId") + ":" + Encryption.encryptGeneral((String)jsonObject.getString("publicKey"), (String)("{\"userAgent\":\"" + this.userAgent + "\"}"))));
