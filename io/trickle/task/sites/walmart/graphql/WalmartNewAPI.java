        ...
        switch (n2) {
            case 0: {
                ...
                try {
                    ...
                    return ((CompletableFuture)completableFuture3.exceptionally(Function.identity())).thenCompose(arg_0 -> WalmartNewAPI.async$generatePX(walmartNewAPI, n, (WalmartNewAPI)((Object)object), completableFuture3, 1, arg_0));
                }
                catch (Exception exception) {
                    System.out.println("Error generating desktop session: " + exception.getMessage());
                    return CompletableFuture.completedFuture(false);
