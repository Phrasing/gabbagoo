 ...
 *  io.trickle.task.sites.walmart.canada.PaymentInstance
...
lbl15:
    ...
    public CompletableFuture initCheckout() {
        this.payment = PaymentInstance.get((WalmartCA)this, (Task)this.task, (PaymentToken)this.token);
...
lbl10:
                ...
                if (!((Boolean)v0.join()).booleanValue()) ** GOTO lbl16
                v1 = var0.tryCart();
                if (!v1.isDone()) {
                    var1_1 = v1;
                    return var1_1.exceptionally(Function.<T>identity()).thenCompose((Function<Object, CompletableFuture>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, async$run(io.trickle.task.sites.walmart.canada.WalmartCA java.util.concurrent.CompletableFuture int java.lang.Object ), (Ljava/lang/Object;)Ljava/util/concurrent/CompletableFuture;)((WalmartCA)var0, (CompletableFuture)var1_1, (int)2));
...
lbl21:
    ...
    public CompletableFuture tryCart() {
        int n = 0;
        PaymentInstance.State state = null;
        while (this.running) {
            if (n == 0) {
                try {
                    ...
                    if (!completableFuture.isDone()) {
                        CompletableFuture completableFuture2 = completableFuture;
                        return ((CompletableFuture)completableFuture2.exceptionally(Function.identity())).thenCompose(arg_0 -> WalmartCA.async$tryCart(this, n, state, completableFuture2, 1, arg_0));
                    }
            ...
            if (n == 0) continue;
            if (state == null || state.equals((Object)PaymentInstance.State.FAILED_INIT)) {
                CompletableFuture completableFuture = this.initCheckout();
                if (!completableFuture.isDone()) {
                    CompletableFuture completableFuture3 = completableFuture;
                    return ((CompletableFuture)completableFuture3.exceptionally(Function.identity())).thenCompose(arg_0 -> WalmartCA.async$tryCart(this, n, state, completableFuture3, 2, arg_0));
                }
                state = (PaymentInstance.State)completableFuture.join();
                continue;
            }
            CompletableFuture completableFuture = this.payment.processOrder();
            if (!completableFuture.isDone()) {
                CompletableFuture completableFuture4 = completableFuture;
                return ((CompletableFuture)completableFuture4.exceptionally(Function.identity())).thenCompose(arg_0 -> WalmartCA.async$tryCart(this, n, state, completableFuture4, 3, arg_0));
            }
