 ...
 *  io.trickle.task.sites.walmart.canada.PaymentInstance$State
 *  io.trickle.task.sites.walmart.canada.WalmartCA
 *  io.trickle.task.sites.walmart.canada.WalmartCanadaAPI
...
public class PaymentInstance {
    ...
    public CompletableFuture init() {
        block13: {
            try {
                CompletableFuture completableFuture = this.sendAndHandle(() -> ((WalmartCanadaAPI)this.api).initCheckout());
                ...
                try {
                    CompletableFuture completableFuture3 = this.sendAndHandle(() -> ((WalmartCanadaAPI)this.api).submitEmail(), this.api.submitEmailForm());
                    ...
                    if (jsonObject != null) {
                        CompletableFuture completableFuture5 = this.sendAndHandle(() -> ((WalmartCanadaAPI)this.api).submitAddress(), this.api.addressForm());
                        ...
                        if (jsonObject != null) {
                            CompletableFuture completableFuture7 = this.sendAndHandle(() -> ((WalmartCanadaAPI)this.api).submitCard(), this.api.cardForm(this.token));
                            ...
                            if (jsonObject2 != null && jsonObject2.getBoolean("isSuccess", Boolean.valueOf(false)).booleanValue() && jsonObject2.containsKey("paymentMethods")) {
                                ...
                                CompletableFuture completableFuture9 = this.sendAndHandle(() -> ((WalmartCanadaAPI)this.api).submitPayment(), this.api.paymentForm(this.token));
                                ...
                                if (jsonObject != null && jsonObject.containsKey("paymentInfo") && (jsonObject3 = jsonObject.getJsonArray("paymentInfo").getJsonObject(0)).containsKey("paymentId") && !jsonObject3.getString("paymentId", "").isBlank()) {
                                    ...
                                    if (!jsonObject.toString().contains("IN_STOCK")) return CompletableFuture.completedFuture(State.NO_STOCK);
                                    return CompletableFuture.completedFuture(State.PROCEED_CHECKOUT);
                                }
                            }
                        }
                    }
                    ...
                    return CompletableFuture.completedFuture(State.FAILED_INIT);
                }
            }
            catch (Throwable throwable) {
        ...
        while (this.api.getWebClient().isActive()) {
            ...
            try {
                ...
                if (string.contains("Availability for some of the items")) {
                    ...
                    CompletableFuture completableFuture3 = VertxUtil.randomSignalSleep((String)this.instanceSignal, (long)this.task.getMonitorDelay());
                    if (!completableFuture3.isDone()) {
                        CompletableFuture completableFuture4 = completableFuture3;
                ...
                CompletableFuture completableFuture7 = VertxUtil.randomSignalSleep((String)this.instanceSignal, (long)this.task.getRetryDelay());
                if (!completableFuture7.isDone()) {
                    CompletableFuture completableFuture8 = completableFuture7;
                ...
                CompletableFuture completableFuture = VertxUtil.randomSleep((long)12000L);
                if (!completableFuture.isDone()) {
    ...
    public CompletableFuture sendAndHandle(Supplier supplier, Buffer buffer) {
        ...
        while (this.api.getWebClient().isActive()) {
            ...
            try {
                ...
                if (buffer == null) {
                    CompletableFuture completableFuture = Request.send((HttpRequest)((HttpRequest)supplier.get()));
                    if (!completableFuture.isDone()) {
                        CompletableFuture completableFuture2 = completableFuture;
                    ...
                    CompletableFuture completableFuture = Request.send((HttpRequest)((HttpRequest)supplier.get()), (Buffer)buffer);
                    if (!completableFuture.isDone()) {
