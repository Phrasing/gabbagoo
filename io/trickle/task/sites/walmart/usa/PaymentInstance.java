        ...
        if (this.griefMode) {
            ...
            if (this.griefAlt) {
                ...
                if (completableFuture3 != null) {
                    this.selectShipping();
                    CompletableFuture completableFuture4 = VertxUtil.handleEagerFuture((CompletableFuture)completableFuture3);
                ...
                if (completableFuture3 != null) {
                    ...
                    this.submitShipping();
                    CompletableFuture completableFuture8 = VertxUtil.handleEagerFuture((CompletableFuture)completableFuture3);
                    ...
                    CompletableFuture completableFuture10 = VertxUtil.hardCodedSleep((long)(300L - (Instant.now().toEpochMilli() - l2)));
            ...
            if (completableFuture != null) {
                ...
                this.selectShipping();
                CompletableFuture completableFuture18 = VertxUtil.handleEagerFuture((CompletableFuture)completableFuture);
                ...
                CompletableFuture completableFuture20 = VertxUtil.hardCodedSleep((long)(50L - (Instant.now().toEpochMilli() - l)));
            ...
            if (completableFuture != null) {
                l = Instant.now().toEpochMilli();
                this.submitShipping();
                CompletableFuture completableFuture24 = VertxUtil.handleEagerFuture((CompletableFuture)completableFuture);
                ...
                CompletableFuture completableFuture26 = VertxUtil.hardCodedSleep((long)(300L - (Instant.now().toEpochMilli() - l)));
...
lbl17:
                ...
                var0.selectShipping();
                v2 = VertxUtil.handleEagerFuture((CompletableFuture)var5_51);
                if (!v2.isDone()) {
                    var8_24 = v2;
...
lbl50:
                    ...
                    var0.submitShipping();
                    v4 = VertxUtil.handleEagerFuture((CompletableFuture)var5_51);
                    if (!v4.isDone()) {
                        var8_26 = v4;
...
lbl59:
                    ...
                    while (true) {
                        v4.join();
                        v5 = VertxUtil.hardCodedSleep((long)(300L - (Instant.now().toEpochMilli() - var6_18)));
                        if (!v5.isDone()) {
                            var8_27 = v5;
...
lbl90:
                ...
                var0.selectShipping();
                v10 = VertxUtil.handleEagerFuture((CompletableFuture)var6_17);
                if (!v10.isDone()) {
                    var8_31 = v10;
...
lbl99:
                ...
                while (true) {
                    v10.join();
                    v11 = VertxUtil.hardCodedSleep((long)(50L - (Instant.now().toEpochMilli() - var4_12)));
                    if (!v11.isDone()) {
                        var8_32 = v11;
...
lbl117:
                    ...
                    var0.submitShipping();
                    v13 = VertxUtil.handleEagerFuture((CompletableFuture)var6_17);
                    if (!v13.isDone()) {
                        var8_34 = v13;
...
lbl126:
                    ...
                    while (true) {
                        v13.join();
                        v14 = VertxUtil.hardCodedSleep((long)(300L - (Instant.now().toEpochMilli() - var4_13)));
                        if (!v14.isDone()) {
                            var8_35 = v14;
