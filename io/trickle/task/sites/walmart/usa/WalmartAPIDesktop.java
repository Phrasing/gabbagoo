 ...
 *  io.trickle.task.sites.walmart.util.RefererStoreController
        ...
        switch (n2) {
            case 0: {
                ...
                try {
                    ...
                    return ((CompletableFuture)completableFuture3.exceptionally(Function.identity())).thenCompose(arg_0 -> WalmartAPIDesktop.async$generatePX(walmartAPIDesktop, n, (WalmartAPIDesktop)((Object)object), completableFuture3, 1, arg_0));
                }
