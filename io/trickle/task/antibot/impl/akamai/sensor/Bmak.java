 ...
 *  io.trickle.task.antibot.impl.akamai.Devices
...
public class Bmak {
    ...
    public long[] mn_s(String string) {
        ...
        for (int i = 0; i < n6; ++i) {
            try {
                for (int j = 0; j < 16; ++j) {
                    lArray2[i][j] = Ww.leftBitwise((long)Character.codePointAt((CharSequence)object, 64 * i + 4 * j), (long)24L) | Ww.leftBitwise((long)Character.codePointAt((CharSequence)object, 64 * i + 4 * j + 1), (long)16L) | Ww.leftBitwise((long)Character.codePointAt((CharSequence)object, 64 * i + 4 * j + 2), (long)8L) | Character.codePointAt((CharSequence)object, 64 * i + 4 * j + 3);
                }
                continue;
            }
        ...
        while (n7 < n6) {
            ...
            for (int i = 0; i < 64; ++i) {
                ...
                if (i < 16) {
                    ...
                    Long l15;
                    l14 = this.rotate_right((Long)hashMap.get(i - 15), 7) ^ this.rotate_right((Long)hashMap.get(i - 15), 18) ^ (long)Ww.rightTripleBitwise((long)((Long)hashMap.get(i - 15)), (long)3L);
                    Long l16 = (Long)hashMap.get(i - 2);
                    if (l16 == null) {
                        l16 = 0L;
                    }
                    l13 = this.rotate_right(l16, 17) ^ this.rotate_right(l16, 19) ^ (long)Ww.rightTripleBitwise((long)l16, (long)10L);
                    Long l17 = (Long)hashMap.get(i - 16);
                    if (l17 == null) {
                        l17 = 0L;
                    }
        ...
        return new long[]{Ww.rightBitwise((long)n, (long)24L) & 0xFF, Ww.rightBitwise((long)n, (long)16L) & 0xFF, Ww.rightBitwise((long)n, (long)8L) & 0xFF, 0xFF & n, Ww.rightBitwise((long)l, (long)24L) & 0xFF, Ww.rightBitwise((long)l, (long)16L) & 0xFF, Ww.rightBitwise((long)l, (long)8L) & 0xFF, 0xFFL & l, Ww.rightBitwise((long)n2, (long)24L) & 0xFF, Ww.rightBitwise((long)n2, (long)16L) & 0xFF, Ww.rightBitwise((long)n2, (long)8L) & 0xFF, 0xFF & n2, Ww.rightBitwise((long)l2, (long)24L) & 0xFF, Ww.rightBitwise((long)l2, (long)16L) & 0xFF, Ww.rightBitwise((long)l2, (long)8L) & 0xFF, 0xFFL & l2, Ww.rightBitwise((long)n3, (long)24L) & 0xFF, Ww.rightBitwise((long)n3, (long)16L) & 0xFF, Ww.rightBitwise((long)n3, (long)8L) & 0xFF, 0xFF & n3, Ww.rightBitwise((long)l3, (long)24L) & 0xFF, Ww.rightBitwise((long)l3, (long)16L) & 0xFF, Ww.rightBitwise((long)l3, (long)8L) & 0xFF, 0xFFL & l3, Ww.rightBitwise((long)n4, (long)24L) & 0xFF, Ww.rightBitwise((long)n4, (long)16L) & 0xFF, Ww.rightBitwise((long)n4, (long)8L) & 0xFF, 0xFF & n4, Ww.rightBitwise((long)l4, (long)24L) & 0xFF, Ww.rightBitwise((long)l4, (long)16L) & 0xFF, Ww.rightBitwise((long)l4, (long)8L) & 0xFF, 0xFFL & l4};
    }
    ...
    public long rotate_right(long l, int n) {
        return Ww.rightTripleBitwise((long)l, (long)n) | Ww.leftBitwise((long)l, (long)32L) - n;
    }
