...
import io.trickle.task.antibot.impl.px.payload.captcha.DesktopPXNEW$ResponseHandler;
...
extends PerimeterX {
     ...
     */
    public static CompletableFuture async$_execute(DesktopPXNEW var0, String var1_1, Supplier var2_2, Object var3_3, DesktopPXNEW$ResponseHandler var4_4, int var5_5, int var6_6, HttpRequest var7_7, CompletableFuture var8_9, HttpResponse var9_10, Throwable var10_11, int var11_13, Object var12_18) {
        /*
    ...
    public static CompletableFuture async$initialise(DesktopPXNEW var0, DesktopPXNEW var1_1, CompletableFuture var2_2, int var3_3, Object var4_4) {
        switch (var3_3) {
            case 0: {
                ...
                v0 = var0;
                v1 = var0.executeAPI("Initialising", var0.apiRequest(-1, false), null, (DesktopPXNEW$ResponseHandler)LambdaMetafactory.metafactory(null, null, null, (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/Object;, bodyAsString(), (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/String;)());
                if (!v1.isDone()) {
                    var2_2 = v1;
                    var1_1 = v0;
    ...
    public CompletableFuture solve() {
        ...
        while (n < 10) {
            try {
                ...
                Buffer buffer = (Buffer)completableFuture.join();
                CompletableFuture completableFuture4 = VertxUtil.hardCodedSleep(this.waitTime);
                ...
                CompletableFuture completableFuture10 = VertxUtil.hardCodedSleep(this.waitTime);
...
lbl14:
                            ...
                            if (!(v1 = var0.executeAPI("API 1", var0.apiRequest(1, false), var0.buildRequestBody(null, null), (DesktopPXNEW$ResponseHandler)LambdaMetafactory.metafactory(null, null, null, (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/Object;, body(), (Lio/vertx/ext/web/client/HttpResponse;)Lio/vertx/core/buffer/Buffer;)())).isDone()) {
                                var7_10 = v1;
...
lbl17:
                            ...
                            while (true) {
                                ...
                                v2 = VertxUtil.hardCodedSleep(var0.waitTime);
                                if (!v2.isDone()) {
                                    var7_11 = v2;
...
lbl23:
                                ...
                                while (true) {
                                    v2.join();
                                    v3 = var0.executePX("Sensor 1/2", (Supplier<HttpRequest>)LambdaMetafactory.metafactory(null, null, null, ()Ljava/lang/Object;, collectorReq(), ()Lio/vertx/ext/web/client/HttpRequest;)((DesktopPXNEW)var0), var2_2, (DesktopPXNEW$ResponseHandler)LambdaMetafactory.metafactory(null, null, null, (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/Object;, bodyAsString(), (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/String;)());
                                    if (!v3.isDone()) {
                                        var7_12 = v3;
...
lbl30:
                                    ...
                                    while (true) {
                                        ...
                                        v4 = var0.executeAPI("API 2", var0.apiRequest(2, false), var0.buildRequestBody((String)var3_4 /* !! */ , var0.performance), (DesktopPXNEW$ResponseHandler)LambdaMetafactory.metafactory(null, null, null, (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/Object;, body(), (Lio/vertx/ext/web/client/HttpResponse;)Lio/vertx/core/buffer/Buffer;)());
                                        if (!v4.isDone()) {
                                            var7_13 = v4;
...
lbl42:
                                            ...
                                            while (true) {
                                                v5.join();
                                                v6 = var0.executePX("Sensor 2/2", (Supplier<HttpRequest>)LambdaMetafactory.metafactory(null, null, null, ()Ljava/lang/Object;, collectorReq(), ()Lio/vertx/ext/web/client/HttpRequest;)((DesktopPXNEW)var0), var4_5, (DesktopPXNEW$ResponseHandler)LambdaMetafactory.metafactory(null, null, null, (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/Object;, bodyAsString(), (Lio/vertx/ext/web/client/HttpResponse;)Ljava/lang/String;)());
                                                if (!v6.isDone()) {
                                                    var7_15 = v6;
...
lbl49:
                        ...
                        if (!(v7 = VertxUtil.randomSleep(5000L)).isDone()) {
                            var7_16 = v7;
