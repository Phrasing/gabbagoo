...
public class PXCaptcha$1 {
   ...
   static {
      try {
         $SwitchMap$io$trickle$task$antibot$impl$px$Types[Types.CAPTCHA_MOBILE.ordinal()] = 1;
      } catch (NoSuchFieldError var4) {
      }

      try {
         $SwitchMap$io$trickle$task$antibot$impl$px$Types[Types.CAPTCHA_DESKTOP.ordinal()] = 2;
