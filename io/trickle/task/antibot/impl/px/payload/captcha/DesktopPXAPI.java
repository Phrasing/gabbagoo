...
extends PerimeterX {
    ...
    static {
        DEFAULT_UA = AsciiString.cached((String)"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36");
    ...
    public boolean validateError(String string) {
        ...
        if (string != null) return string2.contains("not valid") || string2.contains("proxy");
        return true;
    }
    ...
    public CompletableFuture solve() {
        ...
        while (n <= 30) {
            try {
                ...
                CompletableFuture completableFuture = Request.send((HttpRequest)this.solveRequest());
    ...
    public CompletableFuture solveCaptcha(String string, String string2, String string3) {
        ...
        while (n <= 30) {
            try {
                ...
                CompletableFuture completableFuture = Request.send((HttpRequest)this.captchaRequest());
                if (!completableFuture.isDone()) {
                    CompletableFuture completableFuture2 = completableFuture;
