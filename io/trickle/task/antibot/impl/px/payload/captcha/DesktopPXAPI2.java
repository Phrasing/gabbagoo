    ...
    public CompletableFuture solveCaptcha(String string, String string2, String string3) {
        ...
        for (int i = 0; i < 4; ++i) {
            try {
                ...
                CompletableFuture completableFuture = VertxUtil.randomSleep((long)8000L);
                if (!completableFuture.isDone()) {
...
lbl8:
                    ...
                    while (true) {
                        ...
                        if (!(v1 = VertxUtil.hardCodedSleep((long)var0.delay)).isDone()) {
                            var2_5 = v1;
...
lbl36:
    ...
    public CompletableFuture solveHold() {
        try {
            ...
            CompletableFuture completableFuture3 = VertxUtil.hardCodedSleep((long)this.delay);
            ...
            case 0: {
                ...
                while (var3_3 < 30) {
                    try {
                        ...
                        if (!(v0 = Request.send((HttpRequest)var2_2, (Buffer)var0.getMetaPayload().toBuffer())).isDone()) {
                            var6_8 = v0;
...
lbl11:
    ...
    public CompletableFuture fetchUA() {
        ...
        if (!this.logger.isDebugEnabled()) return Request.executeTillOk((HttpRequest)httpRequest);
        this.logger.debug("Fetching new User-Agent");
        return Request.executeTillOk((HttpRequest)httpRequest);
    }
...
lbl54:
                ...
                if (!(v5 = VertxUtil.randomSleep((long)8000L)).isDone()) {
                    var8_15 = v5;
        ...
        while (n2 < 30) {
            block7: {
                try {
                    ...
                    CompletableFuture completableFuture = Request.send((HttpRequest)httpRequest, (Buffer)this.getMetaPayload().toBuffer());
                    if (!completableFuture.isDone()) {
                        CompletableFuture completableFuture2 = completableFuture;
            ...
            try {
                if (this.userAgent == null) {
                    ...
                    if (string != null && !string.isEmpty() && !string.equalsIgnoreCase("error")) {
                        ...
                        String string2 = Utils.parseChromeVer((String)string);
        ...
        while (n < 30) {
            try {
                ...
                if (bl) {
                    ...
                    CompletableFuture completableFuture = Request.send((HttpRequest)this.delegate.getWebClient().request(HttpMethod.POST, requestOptions), (Buffer)Buffer.buffer((String)this.currentPayload));
                    if (!completableFuture.isDone()) {
                        CompletableFuture completableFuture3 = completableFuture;
