...
import io.trickle.task.antibot.impl.px.payload.captcha.Devices$1;
import io.trickle.task.antibot.impl.px.payload.captcha.Devices$2;
import io.trickle.task.antibot.impl.px.payload.captcha.Devices$3;
...
import io.trickle.task.antibot.impl.px.payload.captcha.Devices$GeneratedDevice;
...
lbl11:
                ...
                return CompletableFuture.completedFuture(new Devices$DeviceImpl(var1_1));
            }
        }
