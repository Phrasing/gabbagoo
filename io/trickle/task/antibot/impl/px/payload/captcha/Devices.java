 ...
 *  io.trickle.task.antibot.impl.px.payload.captcha.Devices$1
 *  io.trickle.task.antibot.impl.px.payload.captcha.Devices$2
 *  io.trickle.task.antibot.impl.px.payload.captcha.Devices$3
 *  io.trickle.task.antibot.impl.px.payload.captcha.Devices$Device
 *  io.trickle.task.antibot.impl.px.payload.captcha.Devices$DeviceImpl
 *  io.trickle.task.antibot.impl.px.payload.captcha.Devices$GeneratedDevice
...
extends Enum {
    public static /* enum */ Devices CHROME_89 = new 1("CHROME_89", 0);
    ...
    static {
        Z3_JX_WIN = new 2("Z3_JX_WIN", 1);
        PX_SDK_ANDROID = new 3("PX_SDK_ANDROID", 2);
...
lbl11:
                ...
                var2_2 = (JsonObject)v0.join();
                return CompletableFuture.completedFuture(new DeviceImpl(var1_1));
            }
        }
    ...
    public static Device randomLocalWebview() {
