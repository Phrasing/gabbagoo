 ...
 *  io.trickle.task.antibot.impl.px.PXToken$1
...
lbl37:
                            ...
                            v8 = VertxUtil.randomSleep((long)10000L);
                            if (!v8.isDone()) {
                                var6_12 = v8;
    ...
    public CompletableFuture initialize() {
        ...
        while (n < 5) {
            try {
                ...
                CompletableFuture completableFuture8 = VertxUtil.randomSleep((long)10000L);
...
lbl11:
                        ...
                        while (true) {
                            ...
                            var0.secondPayload = new SecondPayload(var2_2 /* !! */ , (JsonObject)var3_4, var0.requestTime, var0.SITE);
                            v1 = var0.sendPayload(var0.secondPayload.asForm());
                            if (!v1.isDone()) {
                                var6_9 = v1;
